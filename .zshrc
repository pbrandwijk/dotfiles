...
# Uses the Vi keymaps (vicmd, viins, …) with Vi-style default key bindings
...
# Turn off CTRL-S (XOFF) from Software flow control so that CTRL-S can be used in vim
# without blocking the terminal. Alternative command:
# stty -ixon
stty stop ""
